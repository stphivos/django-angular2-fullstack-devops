...
export class SeedConfig {
  ...
  APP_TITLE = 'Angular2 App';

  APP_SRC = 'src/client';
  ASSETS_SRC = `${this.APP_SRC}/assets`;
  CSS_SRC = `${this.ASSETS_SRC}/css`;
  JS_SRC = `${this.ASSETS_SRC}/js`;
  ...
  CSS_DEST = `${this.ASSETS_DEST}/css`;
  JS_DEST = `${this.ASSETS_DEST}/js`;
  VERSION = appVersion();
  ...
  APP_ASSETS:InjectableDependency[] = [
    ...
    {src: `${this.JS_SRC}/site.js`, inject: true, vendor: false},
  ];
